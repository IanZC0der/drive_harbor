...
@EnableCaching
@ComponentScan(value = driveHarborConstants.BASE_COMPONENT_SCAN_PATH + ".cache.caffeine.test")
public class CaffeineCacheConfig {
    ...
    public CacheManager caffeineCacheManager() {
        CaffeineCacheManager cacheManager = new CaffeineCacheManager(CacheConstants.DRIVE_HARBOR_CACHE_NAME);
